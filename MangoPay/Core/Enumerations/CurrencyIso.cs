...
namespace MangoPay.Core
{
    ...
    public enum CurrencyIso
    {
        ...
        COP,
        /// <summary>Unidad de Valor Real (UVR) (funds code)[7]</summary>
        COU,
        ...
        SSP,
        /// <summary>Sao Tomé and Príncipe dobra</summary>
        STD,
        ...
        TND,
        /// <summary>Tongan pa‘anga</summary>
        TOP,
        ...
        USN,
        /// <summary>United States dollar (same day) (funds code)[10]</summary>
        USS,
        ...
        XBD,
        /// <summary>bitcoinInternational internet currency</summary>
        XBT,
        ...
        XOF,
        /// <summary>Palladium (onetroy ounce)</summary>
        XPD,
        /// <summary>CFP franc(franc Pacifique)</summary>
        XPF,
        /// <summary>Platinum (onetroy ounce)</summary>
        XPT,
