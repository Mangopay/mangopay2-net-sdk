...
namespace MangoPay.SDK.Core.APIs
{
    ...
    public abstract class ApiBase
    {
        ...
        private readonly Dictionary<MethodKey, ApiEndPoint> _methods = new Dictionary<MethodKey, ApiEndPoint>
        {
            ...
            {
                MethodKey.PreauthorizationTransactionsGet,
                new ApiEndPoint("/preauthorizations/{0}/transactions", RequestType.GET)
            },
            ...
            {
                MethodKey.PayinsPreauthorizedDirectCreate,
                new ApiEndPoint("/payins/preauthorized/direct", RequestType.POST)
            },
            ...
            {
                MethodKey.PayinsPayconiqV2WebCreate,
                new ApiEndPoint("/payins/payment-methods/payconiq", RequestType.POST)
            },

            { MethodKey.PayinsDirectDebitCreate, new ApiEndPoint("/payins/directdebit/web", RequestType.POST) },
            {
                MethodKey.PayinsMandateDirectDebitCreate,
                new ApiEndPoint("/payins/directdebit/direct", RequestType.POST)
            },
            ...
            {
                MethodKey.GooglePayinsDirectCreateV2,
                new ApiEndPoint("/payins/payment-methods/googlepay", RequestType.POST)
            },

            { MethodKey.PayinsMbwayWebCreate, new ApiEndPoint("/payins/payment-methods/mbway", RequestType.POST) },
            {
                MethodKey.PayinsMultibancoWebCreate,
                new ApiEndPoint("/payins/payment-methods/multibanco", RequestType.POST)
            },
            {
            ...
            {
                MethodKey.PayinsBancontactWebCreate,
                new ApiEndPoint("/payins/payment-methods/bancontact", RequestType.POST)
            },
            { MethodKey.PayinsSwishWebCreate, new ApiEndPoint("/payins/payment-methods/swish", RequestType.POST) },
            {
                MethodKey.PayinsPayByBankWebCreate,
                new ApiEndPoint("/payins/payment-methods/openbanking", RequestType.POST)
            },
            ...
            {
                MethodKey.PayinsGetRecurringRegistration,
                new ApiEndPoint("/recurringpayinregistrations/{0}", RequestType.GET)
            },
            {
                MethodKey.PayinsPutRecurringRegistration,
                new ApiEndPoint("/recurringpayinregistrations/{0}", RequestType.PUT)
            },
            { MethodKey.PayinsRecurringCardDirect, new ApiEndPoint("/payins/recurring/card/direct", RequestType.POST) },

            {
                MethodKey.PayInsCreateCardPreAuthorizedDeposit,
                new ApiEndPoint("/payins/deposit-preauthorized/direct/full-capture", RequestType.POST)
            },
            ...
            {
                MethodKey.UsersCreateBankAccountsOther,
                new ApiEndPoint("/users/{0}/bankaccounts/other", RequestType.POST)
            },
            ...
            { MethodKey.UsersEnrollSca, new ApiEndPoint("/sca/users/{0}/enrollment", RequestType.POST) },
            ...
            {
                MethodKey.ClientGetWalletsFeesWithCurrency,
                new ApiEndPoint("/clients/wallets/fees/{0}", RequestType.GET)
            },
            {
                MethodKey.ClientGetWalletsCreditWithCurrency,
                new ApiEndPoint("/clients/wallets/credit/{0}", RequestType.GET)
            },

            { MethodKey.ClientGetTransactions, new ApiEndPoint("/clients/transactions", RequestType.GET) },
            {
                MethodKey.ClientGetWalletTransactions,
                new ApiEndPoint("/clients/wallets/{0}/{1}/transactions", RequestType.GET)
            },
            {
                MethodKey.ClientCreateBankwireDirect,
                new ApiEndPoint("/clients/payins/bankwire/direct", RequestType.POST)
            },
            ...
            {
                MethodKey.DisputesDocumentPageCreate,
                new ApiEndPoint("/disputes/{0}/documents/{1}/pages", RequestType.POST)
            },
            ...
            {
                MethodKey.DisputesRepudiationCreateSettlement,
                new ApiEndPoint("/repudiations/{0}/settlementtransfer", RequestType.POST)
            },
            ...
            {
                MethodKey.MandatesGetForBankAccount,
                new ApiEndPoint("/users/{0}/bankaccounts/{1}/mandates/", RequestType.GET)
            },
            ...
            {
                MethodKey.SingleSignOnExtendInvitation,
                new ApiEndPoint("/clients/ssos/{0}/extendinvitation", RequestType.PUT)
            },
            ...
            {
                MethodKey.SingleSignOnsMePermissionGroup,
                new ApiEndPoint("/ssos/me/permissiongroup", RequestType.GET, false)
            },
            ...
            {
                MethodKey.BankAccountsGetTransactions,
                new ApiEndPoint("/bankaccounts/{0}/transactions", RequestType.GET)
            },
            ...
            {
                MethodKey.VirtualAccountDeactivate,
                new ApiEndPoint("/wallets/{0}/virtual-accounts/{1}", RequestType.PUT)
            },
            ...
            {
                MethodKey.VirtualAccountGetAvailabilities,
                new ApiEndPoint("/virtual-accounts/availability", RequestType.GET)
            },

            {
                MethodKey.IdentityVerificationCreate,
                new ApiEndPoint("/users/{0}/identity-verifications", RequestType.POST)
            },
            { MethodKey.IdentityVerificationGet, new ApiEndPoint("/identity-verifications/{0}", RequestType.GET) },
            {
                MethodKey.IdentityVerificationGetChecks,
                new ApiEndPoint("/identity-verifications/{0}/checks", RequestType.GET)
            }
        };
        ...
        protected async Task<U> CreateObjectAsync<U, T>(MethodKey methodKey, T entity, string idempotentKey = null,
        ...
        protected async Task<ListPaginated<T>> GetListAsync<T>(MethodKey methodKey, Pagination pagination = null,
            Sort sort = null,
        ...
        protected async Task<ListPaginated<T>> GetListAsyncNoClientId<T>(MethodKey methodKey,
        ...
        /// <param name="entitiesId">Entities identifier.</param>
        /// <returns>The Dto instance returned from API.</returns>
        protected async Task<U> UpdateObjectAsync<U, T>(MethodKey methodKey, T entity, string idempotentKey = null,
            params string[] entitiesId)
            where U : EntityBase, new()
